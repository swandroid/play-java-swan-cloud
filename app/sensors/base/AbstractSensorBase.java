...
public abstract class AbstractSensorBase /*extends Service*/ implements
     ...
     */
    protected final HashMap mDefaultConfiguration = new HashMap();

    /**
     * The current configuration of the sensor.
     */
    protected final HashMap currentConfiguration = new HashMap();
    ...
    protected final Map<String, HashMap> registeredHttpConfigurations = new HashMap<String, HashMap>();
     ...
     */
    public abstract void initDefaultConfiguration(HashMap defaults);
